    ...
    render() {
        return (
            <div>
                ...
                <ul>
                    {this.state.articles.map(article => <li key={article._id}>ID: {article._id}, Title: {article.title}, Content: {article.content}, Category: {article.category}, Description: {article.description} </li>) } 
                </ul>
                <hr></hr>
