...
export default class SpecificArticleInput extends Component {
    constructor() {
        super();
    }
    ...
    render() {
        return (
            <div>
                ...
                <ul>
                    <li key={this.state._id}>ID: {this.state._id}, Title: {this.state.title}, Content: {this.state.content}, Category: {this.state.category}, Description: {this.state.description} </li> 
                </ul>
                <hr></hr>
                <br></br>
